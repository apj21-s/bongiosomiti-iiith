...
export default function PujaVideo() {
  ...
  return (
    <div className="events-scene__hero" id="events-hero-player" ref={heroRef}>
      <img className="events-scene__hero-image events-scene__hero-poster" src="/assets/community-puja.webp" alt="IIIT Bongio Samiti Celebrations" />
      <video className="events-scene__hero-video events-scene__hero-video--1 is-hidden" preload="none" muted playsInline aria-label="IIIT Bongio Samiti Celebrations">
        <source data-src="/assets/Animate_Bengali_Puja_courtyard_opt.webm" type="video/webm" />
        <source data-src="/assets/Animate_Bengali_Puja_courtyard_opt_small.mp4" type="video/mp4" />
